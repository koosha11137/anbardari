...
namespace anbar
{
    public partial class Form_factor : Form
    {
        ...
        private void buttonX6_Click(object sender, EventArgs e)
        {
            ...
            DataBase db = new DataBase();
            dt = db.MySelect(str);
            MessageBox.Show(dt.Rows.Count.ToString() + " تعداد رکوردهای یافت شده");
            dataGridViewX1.DataSource = dt;
        }
        ...
        private void dataGridViewX2_MouseUp(object sender, MouseEventArgs e)
        {

        }

        private void dataGridViewX1_MouseUp_1(object sender, MouseEventArgs e)
        {
            DataTable dt = new DataTable();
            DataBase db = new DataBase();
