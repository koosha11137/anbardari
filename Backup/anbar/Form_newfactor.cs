...
namespace anbar
{
    public partial class Form_newfactor : Form
    {
        ...
        private void Form_newfactor_Load(object sender, EventArgs e)
        {
            ...
            dt = db.MySelect("select name,family from foroshandeh");
            comboBoxEx1.DataSource = dt;
            comboBoxEx1.DisplayMember = "family";
            dt = db.MySelect("select family from tahvilgirandeh");
            comboBoxEx2.DataSource = dt;
            comboBoxEx2.DisplayMember = "family";
